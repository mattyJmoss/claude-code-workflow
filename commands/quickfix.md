...
3. **Create a fix branch** — Branch from main (e.g., `fix/PROJ-33-rounding-error`) before making changes.
...
9. **Update memory bank** — Update context.md with what was fixed, the blind spot entry, and ticket status/PR link.
